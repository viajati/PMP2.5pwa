...
export const metadata = {
  title: "Data Deletion",
  description: "Data deletion instructions for PM2.5.",
};
        ...
        <section className="legal-page">
          ...
          <div className="legal-card">
            <p>
              ...
              PM2.5 account, including accounts created through Facebook Login.
            </p>
          </div>

          <div className="legal-section">
            <h2>Remove PM2.5 From Facebook</h2>
            <ol>
          ...
          <div className="legal-section">
            ...
            <p>
              ...
              email address connected to your PM2.5 account to the app owner
              contact email configured in the Meta/Firebase app dashboard.
            </p>
            <p>
              Include the subject line “PM2.5 Data Deletion Request” and the
          ...
          <div className="legal-section">
            ...
            <p>
              Open PM2.5, go to Setup, and use Clear Cache to remove local route
              and history data stored in the browser. You can also clear all site
              data for PM2.5 from your browser settings.
            </p>
          </div>
